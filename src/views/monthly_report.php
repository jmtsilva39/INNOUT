<main class="content">
	...
	//ESSA FUNÇÃO MOSTRA O TÍTULO DA PÁGINA
	renderTitle(
		'Relatório Mensal',
				...
				<?php if ($user->is_admin) : ?>
					<select name="user" class="form-control mr-2" placeholder="Selecione o usuário...">
						...
						foreach ($users as $user) {
							...
							$userName = htmlentities($user->name, ENT_QUOTES, 'UTF-8'); // Aplicando htmlentities()
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<tbody>
				...
				foreach ($report as $registry) : ?>
					<tr>
						<td><?= formatDateWithLocale($registry->work_date, ' %d - %m de %Y') ?></td>
